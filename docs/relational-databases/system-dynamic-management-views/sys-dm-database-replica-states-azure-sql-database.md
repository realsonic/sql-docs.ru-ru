---
description: sys.dm_database_replica_states (база данных SQL Azure)
title: sys.dm_database_replica_states (база данных SQL Azure) | Документация Майкрософт
ms.custom: ''
ms.date: 05/22/2019
ms.prod: sql
ms.reviewer: ''
...
ms.locfileid: "98172166"
---
# <a name="sysdm_database_replica_states-azure-sql-database"></a>sys.dm_database_replica_states (база данных SQL Azure)
[!INCLUDE[Azure SQL Database Azure SQL Managed Instance](../../includes/applies-to-version/asdb-asdbmi.md)]

  Возвращает строку для базы данных, предоставляя состояние для локальной реплики.  
...
|**is_primary_replica**|**bit**|Возвращает 1, если реплика является первичной, или 0, если это вторичная реплика в группе доступности, к которой принадлежит база данных. Это не относится к базе данных-источнику или получателю в распределенной группе доступности или связи активной георепликации.<br /><br />**Применимо к**: [!INCLUDE[ssSQL14](../../includes/sssql14-md.md)] и выше.|  
...
|**secondary_lag_seconds**|**bigint**|Количество секунд, в течение которых вторичная реплика находится за первичной репликой во время синхронизации.<br /><br />**Применимо к**: [!INCLUDE[ssSQL15](../../includes/sssql16-md.md)] и выше.|  
