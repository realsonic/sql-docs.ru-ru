...
|**socket_count** |**int** | **Применимо к:** [!INCLUDE[ssSQL15](../../includes/sssql16-md.md)] с пакетом обновления 2 (SP2) и выше.<br /><br />Указывает число разъемов процессора, доступных в системе. |  
|**cores_per_socket** |**int** | **Применимо к:** [!INCLUDE[ssSQL15](../../includes/sssql16-md.md)] с пакетом обновления 2 (SP2) и выше.<br /><br />Указывает число процессоров на каждый сокет, доступный в системе. |  
|**numa_node_count** |**int** | **Применимо к:** [!INCLUDE[ssSQL15](../../includes/sssql16-md.md)] с пакетом обновления 2 (SP2) и выше.<br /><br />Указывает количество узлов NUMA, доступных в системе. В этом столбце содержатся физические узлы NUMA, а также мягкие узлы NUMA. |  
