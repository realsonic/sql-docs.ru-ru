...
##  <a name="sssql15-and-later"></a><a name="bkmk_2016"></a> [!INCLUDE[ssSQL15](../../includes/sssql16-md.md)] и более поздние версии  
 В следующей таблице описаны столбцы `sys.dm_db_xtp_checkpoint_files` , начиная с **[!INCLUDE[ssSQL15](../../includes/sssql16-md.md)]** .  
