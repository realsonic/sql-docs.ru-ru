...
> -  **_[Предполагаемый план выполнения](../relational-databases/performance/display-the-estimated-execution-plan.md)_*  — это скомпилированный план, созданный оптимизатором запросов.        
...
- Арифметические выражения, такие как 1+1, 5/3_2, которые содержат только константы.
...
> Начиная с [!INCLUDE[ssSQL15](../includes/sssql16-md.md)] с пакетом обновления 1 (SP1) секционированные таблицы и индексы также поддерживаются в выпуске [!INCLUDE[ssNoVersion](../includes/ssnoversion-md.md)] Standard Edition. 
