...
## <a name="breaking-changes-made-in-sssql15"></a>Критические изменения в [!INCLUDE[ssSQL15](../../includes/sssql16-md.md)]  
 [!INCLUDE[ssSQL15](../../includes/sssql16-md.md)] не поддерживает репликацию данных с клиента или на [!INCLUDE[ssVersion2005](../../includes/ssversion2005-md.md)] или [!INCLUDE[ssEW](../../includes/ssew-md.md)].  
