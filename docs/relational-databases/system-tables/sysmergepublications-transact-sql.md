...
|**description**|**nvarchar(255)**|Краткое описание публикации.|  
...
|**designmasterid**|**uniqueidentifier**|Зарезервировано для будущего использования.|  
...
|**status**|**tinyint**|Зарезервировано для будущего использования.|  
