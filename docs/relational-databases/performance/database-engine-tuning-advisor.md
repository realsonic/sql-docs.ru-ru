...
description: Сведения о том, как использовать помощник по настройке ядра СУБД для устранения неполадок, настройки большого набора запросов, анализа изменений структуры и управления дисковым пространством в SQL Server.
ms.custom: ''
ms.date: 01/09/2017
ms.prod: sql
ms.reviewer: ''
