---
title: Отчеты о развертывании и смещении SqlPackage
description: Узнайте, как автоматизировать задачи разработки баз данных с помощью отчетов о развертывании и смещении SqlPackage.exe. Ознакомьтесь с примерами и параметрами публикации, свойствами и переменными SQLCMD.
ms.prod: sql
...
Действие [DriftReport](#driftreport-action-parameters) программы SqlPackage.exe создает XML-отчет по изменениям, которые были внесены в зарегистрированную базу данных со времени ее последней регистрации.  
...
## <a name="deployreport-action-parameters"></a>Параметры действия DeployReport
...
## <a name="deployreport-action-properties"></a>Свойства действия DeployReport
...
## <a name="driftreport-action-parameters"></a>Параметры действия DriftReport
