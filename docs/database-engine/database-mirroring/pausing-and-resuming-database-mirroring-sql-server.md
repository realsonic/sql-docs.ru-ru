...
description: Узнайте, как приостановить и позже возобновить сеанс зеркального отображения базы данных SQL Server, чтобы сохранить состояние сеанса при приостановке зеркального отображения.
