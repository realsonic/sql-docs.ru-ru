---
title: Зеркальное отображение и моментальные снимки баз данных
description: Узнайте о взаимодействии при использовании моментальных снимков базы данных с зеркальным отображением базы данных для разгрузки при формировании отчетов в SQL Server.
ms.custom: ''
ms.date: 03/01/2017
ms.prod: sql
