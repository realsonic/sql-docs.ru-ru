---
title: Просмотр состояния зеркально отображенной базы данных
description: Узнайте, как просмотреть состояние базы данных, настроенной для зеркального отображения базы данных, в графическом интерфейсе среды SQL Server Management Studio (SSMS).
