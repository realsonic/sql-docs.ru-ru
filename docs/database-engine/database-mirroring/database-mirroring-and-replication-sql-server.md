...
description: Узнайте, как использовать зеркальное отображение базы данных совместно с репликацией для повышения доступности базы данных публикации SQL Server.
ms.custom: ''
ms.date: 03/14/2017
ms.prod: sql
