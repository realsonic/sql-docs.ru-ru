...
:::row:::
    ...
    :::column-end:::
    :::column:::
        [Управляемый экземпляр SQL](alter-database-transact-sql-file-and-filegroup-options.md?view=azuresqldb-mi-current&preserve-view=true)
    :::column-end:::
:::row-end:::
...
AUTOGROW_SINGLE_FILE — **применимо к**[!INCLUDE[ssNoVersion](../../includes/ssnoversion-md.md)] ([!INCLUDE[ssSQL15](../../includes/sssql16-md.md)] и выше)
...
:::row:::
    ...
    :::column-end:::
    :::column:::
        **_\* Управляемый экземпляр SQL \*_**<br />&nbsp;
    :::column-end:::
:::row-end:::
