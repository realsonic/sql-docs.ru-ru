 ...
 **Учетная запись**  
 Введите учетную запись пользователя домена Windows в следующем формате: *\<domain>\\<учетная запись пользователя\>* .  
